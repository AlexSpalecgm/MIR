...
for file in $files; do
    ...
    # Обработка файлов с "CV" в имени
        ...
        # Используем awk для обработки строк в файле и исключаем 7-й лейбл из передачи в 9-й
        ...
        NR > 1 {
            ...
            data_value = "CV{" label2_name "=" col2 ", " label3_name "=" col3 ", " label4_name "=" col4 ", " label5_name "=" col5 ", " label6_name "=" col6 ", " label7_name "=" col7 "} " col1  # Не исключаем label7
